export function longestCommonSubsequence(str1: string, str2: string): (string | undefined)[] {
...
function createSubSequenceMatrix(str1: string, str2: string): (string | undefined)[][][] {
  let matrix = [];
